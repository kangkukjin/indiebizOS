...
**6 nodes, 162 composable actions** — one tool (`execute_ibl`), one vocabulary, not 162 schemas:
...
| **self** | 51 | System management, workflows, triggers, files, deep + forager memory, business (catalog/items/docs/guidelines), phone sync, my music library, USB-limb issuance, calendar, health records, library install (approval-gated) |
