...
*Current documentation update: 2026-09-24 — aligned the Cockpit name, edition-2 explicit values/functions/checking/failure/resume contract, criteria-owned final evaluation, the world map, and post-response memory selection with the live system. The long change digest below is historical.*
