...
<!-- IBL_STATS:START -->
**6 nodes, 164 composable actions** — one tool (`execute_ibl`), one vocabulary, not 164 schemas:
...
| **engines** | 18 | Pure media generation — images (generate + vision read/critique), icons, the morning newspaper, websites, web components, TTS. Slides and video moved to `self` in the 2026-08 consolidation |
