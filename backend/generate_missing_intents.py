...
SYNTHETIC_DATA = {
    ...
    "sense:info": [
        ("삼성전자 기본 정보", '[sense:stock_info]{symbol: "삼성전자"}'),
        ("애플 시가총액 알려줘", '[sense:stock_info]{symbol: "AAPL"}'),
        ("종목 정보 조회해줘", "[sense:stock_info]"),
        ("PER이랑 배당 확인해줘", "[sense:stock_info]"),
        ("이 주식 기본 데이터 봐봐", "[sense:stock_info]"),
    ],
    "sense:company_news": [
        ("삼성전자 관련 뉴스", '[sense:news]{symbol: "삼성전자"}'),
        ("테슬라 뉴스 찾아줘", '[sense:news]{symbol: "TSLA"}'),
        ("이 종목 뉴스 뭐 있어", "[sense:news]"),
        ("기업 뉴스 검색해줘", "[sense:news]"),
    ],
    "sense:save": [
