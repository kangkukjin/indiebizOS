...
IBL_NODES_PATH = os.path.join(os.path.dirname(os.path.dirname(__file__)), "..", "data", "ibl_nodes.yaml")
...
INSTRUMENTS_DIR = os.path.join(os.path.dirname(os.path.dirname(__file__)), "..", "data", "instruments")
...
def _load_external_hostnames():
    ...
    hosts = set()
    try:
        cfg_path = os.path.join(os.path.dirname(os.path.dirname(__file__)), "..", "data", "tunnel_config.json")
    ...
    try:
        pf_path = os.path.join(os.path.dirname(os.path.dirname(__file__)), "..", "data", "public_face.json")
...
_LAUNCHER_ASSETS = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), "assets", "launcher")
