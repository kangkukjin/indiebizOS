...
<p id="browserLoginStatus" role="status"></p><small>AI 요청은 허브와 모델 제공자가 처리합니다. 다른 기기와 기억을 자동 공유하지 않습니다.</small></main>'''
    ...
    css = '''#memberLogin{max-width:580px;margin:7vh auto}#memberLogin p{line-height:1.8}#browserLoginForm{position:static;display:flex;flex-direction:column}#browserKey{display:block;width:100%;padding:15px;margin:12px 0;border:1px solid #bdc9c1;border-radius:10px;font:inherit}.browserTools{display:flex;gap:8px}#browserStorage{margin:12px 0}#workspacePicker{display:none}.fileActions{flex-wrap:wrap}#importFile{max-width:100%}@media(max-width:700px){header{align-items:flex-start;gap:8px}.browserTools{flex-direction:column}#memberLogin{margin:3vh auto}#send{flex-wrap:wrap}#message{min-width:100%;max-width:100%;box-sizing:border-box}#filePath{width:100%}#memberWorkspace{padding:16px}#memberWorkspace header h1{font-size:17px}#memberWorkspace #notice{font-size:12px;margin:8px 0}#memberWorkspace .browserTools{flex-direction:row;gap:4px}#memberWorkspace .browserTools button{padding:8px;font-size:12px}#workspaceLayout{margin-top:12px;gap:14px}#taskSidebar{padding:0 0 8px}#taskSidebar>p,#taskSidebar>h3,#workspacePath{display:none}#taskList{margin-top:6px}#taskList button{margin:0;padding:8px}#taskTitle{margin:8px 0;font-size:20px}#memberNav{margin:10px 0}#taskControls{margin:8px 0}#appFrame{height:70vh}.user{margin-left:15px}.assistant{margin-right:0}}'''
