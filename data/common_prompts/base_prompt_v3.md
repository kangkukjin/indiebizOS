...
2. **Plan**: What tools/files/information are needed? Break into steps with todo_write.
3. **Execute**: Perform each step, using parallel tool calls when independent.
4. **Verify**: Does the result match the original request? Any side effects?
