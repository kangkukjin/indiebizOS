...
- goal 블록은 **문장 위치에 통째로** 쓴다 — 여러 문장 코드 안에서 다른 문장과 **줄(또는 ;)로 분리**해 섞을 수 있다. (if/case/repeat/try 는 2026-08-22 M6 이후 **파이프 세그먼트로도** 들어간다 — 정본은 교재의 M6 절. goal 은 목적 선언이라 파이프에 잇지 않는다.)
