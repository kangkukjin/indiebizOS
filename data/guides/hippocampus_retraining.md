...
| 기계 | 판정 |
|------|------|
| 맥미니 M4 Pro (24GB) | **로컬로 그냥 된다.** epoch 당 ~100초(학습쌍 3천)~5분(8.5천, 2026-09-18), 전체 15분~1시간. 실증 07-21·08-04·09-18 |
...
| 2026-09-18 | 3,635건 → **학습쌍 8,534** | **7** (조기종료 10) | 0.895 | 실행기억 다듬기 직후(전수 정독·문법 감사·조합 용례 +73·근접 중복). A/B(동일 분할) 6지표 전부 우세: code T1/3/5 55.5/75.1/82.8→57.9/81.6/**88.8** · desc 63.7/82.3/88.5→**71.0**/88.3/91.5 · 프로브 62→61/66(새 13개 전부 적중, 빠진 3 = `sense:feed` 퓨리서치·`self:read` PDF 표·`table:ai` 광고성 — 상한 20 밸런싱의 흔들림, 다음 시딩 표적) → 채택. epoch 당 ~5분(8.5천 쌍) |
