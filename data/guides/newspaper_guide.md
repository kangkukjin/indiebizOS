...
```
[engines:newspaper]("AI, 청주, 세종, 문화, 여행, 과학, 경제") >> [self:open]("browse")
```
...
| params.count | - | 키워드당 기사 수 (기본: 7) |

### 예시

기본 (생성만):
```
[engines:newspaper]("AI, 청주, 세종, 경제")
```

생성 후 브라우저 열기:
```
[engines:newspaper]("AI, 경제, 주식") >> [self:open]("browse")
```

제목 지정 + 출처 제외:
```
[engines:newspaper]("AI, 경제, 주식") {"title": "투자 뉴스", "exclude_sources": ["조선일보"]} >> [self:open]("browse")
```
...
RIGHT: [engines:newspaper]("AI") >> [self:open]("browse")
```
