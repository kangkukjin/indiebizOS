...
- **시도코드 재편 — `op:"codes"` 카탈로그가 낡았다**: 강원 42→**51**(원주 51130·동해 51170), 전북 45→**52**(전주 완산 52111), 전남+광주 46/29→**12**(나주 12170·광주 서구 12240). 낡은 코드는 에러가 아니라 **조용히 0건**이다. 재편 없음 확인: 서울 11·부산 26·대구 27·울산 31·충북 43·충남 44·경북 47·경남 48·제주 50. 모르는 코드는 네이버 지명 해소의 `cortarNo` 앞 5자리에서 캔다. (카탈로그 표 수리 = `tool_region_codes.py` REGION_CODES, 별도 과제.)
