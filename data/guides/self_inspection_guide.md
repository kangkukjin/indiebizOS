...
## 실측 기록 (자동 누적)
- 2026-09-14 실측: 에피소드 3782·3783은 호출 원문에서 관용구 사용이 확인됐지만 자동 통계에는 0회로 집계됐다.
- 2026-09-14 실측: 통계 스크립트가 보고한 ‘문법 오류 39건’이 실제 실패 수와 일치하지 않았다. 오집계 원인은 제공된 기록에서 확정되지 않았다.
