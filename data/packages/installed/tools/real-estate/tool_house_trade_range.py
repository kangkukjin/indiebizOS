...
def get_house_trade_range(region_code: str, start_month: str, end_month: str = None, count_per_month: int = 30):
    """
    ...
    try:
        ...
        if e.code in (401, 403):
            return {"success": False, "error": "단독/다가구 매매 실거래가 API 권한이 없습니다(403). data.go.kr에서 동일 키로 활용신청하세요."}
