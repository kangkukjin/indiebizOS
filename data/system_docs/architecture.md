...
- backend **.py 438개**(test 제외, git 추적 기준) — 층 디렉토리 `base 54 · datastore 66 · ibl 58 · cognition 76 · services 39 · surface 81`(+ common 21·providers 13·channels 4·drivers 3). 가이드 **85개**(guide_db 등록 **83**)
