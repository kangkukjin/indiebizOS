...
- backend **.py 303개**(test 제외, git 추적 기준) — 층 디렉토리 `base 28 · datastore 40 · ibl 42 · cognition 48 · services 28 · surface 61`(+ common 16·providers 13·channels 4·drivers 3). 가이드 **71개**(guide_db 등록 **70**)
