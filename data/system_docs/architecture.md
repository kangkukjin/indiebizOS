...
- backend **.py 320개**(test 제외, git 추적 기준) — 층 디렉토리 `base 30 · datastore 44 · ibl 45 · cognition 52 · services 28 · surface 62`(+ common 17·providers 13·channels 4·drivers 3). 가이드 **73개**(guide_db 등록 **72**)
