...
[4b] 도구 없는 평가자 → 목표·실행 기록·결과로 판정, 실행자에게 최대 1회 부분 보완 인계
...
- backend **.py 372개**(test 제외, git 추적 기준) — 층 디렉토리 `base 45 · datastore 49 · ibl 50 · cognition 64 · services 36 · surface 67`(+ common 19·providers 13·channels 4·drivers 3). 가이드 **75개**(guide_db 등록 **74**)
