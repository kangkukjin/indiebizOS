...
- backend **.py 296개**(test 제외, git 추적 기준) — 층 디렉토리 `base 26 · datastore 38 · ibl 40 · cognition 47 · services 28 · surface 61`(+ common 16·providers 13·channels 4·drivers 3). 가이드 **70개**(guide_db 등록 **69**)
