...
|------------|------------------|------|
| 신경계 | IBL (5노드, 124액션) | 감각/행동의 상시 연결 |
...
- **5개 노드, 124 액션** (라운드 2 통합 + op 어휘화 + 사용성 재감사 + 어휘 정리 + 메신저/비즈니스 IBL화 + neighbor 통합 + 폰 온디맨드 감각 삼각 후)
  - sense(41), self(41), limbs(17), others(11), engines(14)
...
- 도구 패키지: 35개, IBL: 5노드 124액션 (라운드 2 + op 어휘화 + 사용성 재감사 + 안드로이드 통합 + 메신저/비즈니스 IBL화 + neighbor 통합 + 폰 온디맨드 감각 삼각)
