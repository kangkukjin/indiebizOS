...
- backend **.py 432개**(test 제외, git 추적 기준) — 층 디렉토리 `base 52 · datastore 65 · ibl 58 · cognition 73 · services 39 · surface 81`(+ common 21·providers 13·channels 4·drivers 3). 가이드 **83개**(guide_db 등록 **81**)
