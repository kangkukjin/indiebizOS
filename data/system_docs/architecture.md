...
- backend **.py 336개**(test 제외, git 추적 기준) — 층 디렉토리 `base 33 · datastore 46 · ibl 47 · cognition 57 · services 28 · surface 64`(+ common 19·providers 13·channels 4·drivers 3). 가이드 **74개**(guide_db 등록 **73**)
