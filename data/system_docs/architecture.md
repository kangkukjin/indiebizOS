...
- backend **.py 419개**(test 제외, git 추적 기준) — 층 디렉토리 `base 52 · datastore 57 · ibl 58 · cognition 73 · services 37 · surface 79`(+ common 20·providers 13·channels 4·drivers 3). 가이드 **82개**(guide_db 등록 **81**)
