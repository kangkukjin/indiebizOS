...
- backend **.py 346개**(test 제외, git 추적 기준) — 층 디렉토리 `base 34 · datastore 48 · ibl 48 · cognition 62 · services 29 · surface 64`(+ common 19·providers 13·channels 4·drivers 3). 가이드 **75개**(guide_db 등록 **74**)
