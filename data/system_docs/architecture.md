...
- backend **.py 354개**(test 제외, git 추적 기준) — 층 디렉토리 `base 36 · datastore 48 · ibl 50 · cognition 62 · services 32 · surface 65`(+ common 19·providers 13·channels 4·drivers 3). 가이드 **75개**(guide_db 등록 **74**)
