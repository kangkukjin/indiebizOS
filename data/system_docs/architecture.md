...
- backend **.py 371개**(test 제외, git 추적 기준) — 층 디렉토리 `base 45 · datastore 49 · ibl 50 · cognition 63 · services 36 · surface 67`(+ common 19·providers 13·channels 4·drivers 3). 가이드 **75개**(guide_db 등록 **74**)
