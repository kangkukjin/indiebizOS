...
- backend **.py 291개**(test 제외, git 추적 기준) — 층 디렉토리 `base 24 · datastore 36 · ibl 40 · cognition 45 · services 28 · surface 60`(+ common 16·providers 13·channels 4·drivers 3). 가이드 **68개**(guide_db 등록 **67**)
