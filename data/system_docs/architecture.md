...
- backend **.py 467개**(test 제외, git 추적 기준) — 층 디렉토리 `base 57 · datastore 67 · ibl 80 · cognition 77 · services 39 · surface 81`(+ common 23·providers 13·channels 4·drivers 3). 가이드 **87개**(guide_db 등록 **84**)
