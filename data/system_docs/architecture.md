...
- backend **.py 388개**(test 제외, git 추적 기준) — 층 디렉토리 `base 48 · datastore 51 · ibl 55 · cognition 65 · services 36 · surface 70`(+ common 20·providers 13·channels 4·drivers 3). 가이드 **75개**(guide_db 등록 **74**)
