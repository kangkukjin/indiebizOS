...
- backend **.py 280개**(test 제외, git 추적 기준) — 층 디렉토리 `base 23 · datastore 35 · ibl 36 · cognition 43 · services 28 · surface 60`(+ common 15·providers 11·channels 4·drivers 3). 가이드 **68개**(guide_db 등록 **67**)
