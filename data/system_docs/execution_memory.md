...
[3] 실행 에이전트 ← 시스템 프롬프트에 연상기억 + (의식 출력)
    Reflex(해마 고확신) → 중급 모델 / EXECUTE·THINK → 본격 모델 (2026-06-10: EXECUTE 중급→본격)
    ↓
