...
- **`[team:list_projects]`**: 프로젝트/에이전트 목록 조회
- **`[team:delegate_project]`**: 특정 에이전트에게 작업 위임
...
- **활성 프로젝트**: 24개
- **도구 패키지**: 35개 (설치됨)
- **IBL 노드**: 7개 (source 105, interface 79, system ~57, forge 46, stream 18, messenger 9, team 7), 총 321 액션
- **마지막 업데이트**: 2026-03-05
