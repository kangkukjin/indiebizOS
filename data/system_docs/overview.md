...
- **의식 시스템**: 매시간 세계/사용자/자신 상태 수집 (Consciousness Pulse) + 매 6시간 IBL 액션 자가 점검 (Self-Check)
...
- **IBL 노드 추상화**: `[node:action]{params}` 문법으로 5개 노드(sense, self, limbs, others, engines)의 321 액션 통합
...
- **활성 프로젝트**: 24개
- **도구 패키지**: 35개 (설치됨)
- **IBL 노드**: 5개 (sense 105, limbs 97, self ~57, others 16, engines 46), 총 321 액션
- **마지막 업데이트**: 2026-03-12
