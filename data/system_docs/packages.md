---
title: 도구 패키지 시스템
scope: 패키지 구조(handler/tool.json), 설치 절차, 40개 패키지 목록. IBL 어휘 등록은 각 패키지의 ibl_actions.yaml(능력 자기완결, ibl.md 참조). op 분기 패키지 26개는 `_OP_DISPATCHERS` 표준 채택.
