...
- **완료(4패키지)**: culture(book — 표지 카탈로그✓), study(paper/arxiv — 나머지 3소스 남음), location(restaurant), web(search_gnews·search_ddg·search_naver). book>>document(표지)·book>>spreadsheet(11행)·restaurant·paper·news·ddg·naver >> document 전부 라이브✓. 비파괴.
