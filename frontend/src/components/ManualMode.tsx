...
import { NodePresence, ModelGearLever, ActiveProjects, LimbSwitch, SystemLogViewer } from './launcher-components';
  ...
  return (
    <div className="h-full overflow-y-auto bg-[#F5F1EB]">
      <div className="max-w-2xl mx-auto px-5 py-6 space-y-4">
        ...
        {structOpen && (
          <div className="rounded-xl border border-stone-200 bg-white/70 max-h-[60vh] overflow-y-auto">
            {structLoading ? (
        ...
        {/* 시스템 로그 — 아이콘 실행(터미널 없음)에서 부팅 에러·백그라운드 서비스 로그를 보는 창구 (2026-08-05) */}
        <SystemLogViewer />
