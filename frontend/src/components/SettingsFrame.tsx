...
export function SettingsFrame({ children, onClose, icon, width = 750, height = 650,
    ...
    <div className="fixed inset-0 bg-black/30 flex items-center justify-center z-50">
      <div role="dialog" aria-modal="true" aria-label="설정"
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-gray-200 bg-gray-50 shrink-0">
          ...
          <button onClick={onClose} aria-label="설정 닫기" className="p-1.5 hover:bg-gray-200 rounded-lg transition-colors">
