 ...
 * 해시 라우트)에서만 '‹ 뒤로' 를 둔다.
 */
export function ToolWindowFrame({ title, icon, actions, children, onContextMenu }: {
  title: string;
  icon?: ReactNode;
  actions?: ReactNode;
  children: ReactNode;
  ...
  return (
    <div className="h-screen w-screen flex flex-col overflow-hidden bg-[#FAF8F4]">
      <div onContextMenu={onContextMenu} className="flex items-center gap-3 px-5 py-3 border-b border-[#E5DFD5] bg-gradient-to-b from-[#F7F3ED] to-[#F5F1EB] shrink-0">
        {isWeb && (
