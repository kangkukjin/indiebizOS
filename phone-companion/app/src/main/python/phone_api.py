...
from phone_execution_routes import install as _install_execution_routes
_install_execution_routes(app, lambda: _scratch, lambda obj: _save_audio_to_phone(obj))
