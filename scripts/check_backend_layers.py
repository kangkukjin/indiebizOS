...
LAYERS = {
    ...
    "ibl": {
        ...
        "ibl_v2_compile", "ibl_v2_contracts", "ibl_v2_learning", "ibl_v2_compat", "ibl_v2_runtime", "ibl_v2_adapters", "ibl_v2_entry", "ibl_v2_store", "ibl_document_value", "ibl_member_library", "ibl_run_journal", "ibl_remote_call",
