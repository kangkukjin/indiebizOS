...
LAYERS = {
    ...
    "data": {
        ...
        "forage_memory", "forage_doc", "hippo_tree", "guide_registry", "health_sync", "finance_ledger_sync", "ibl_registry", "ibl_usage_db",
        "install_approvals",
    ...
    "ibl": {
        ...
        "ibl_progress",
        "ibl_predicates",
        "ibl_parser", "ibl_parser_blocks", "ibl_parser_values", "ibl_routing", "ibl_turn_vars",
    ...
    "cognition": {
        ...
        "ibl_description_audit", "corpus_vocab_audit", "ibl_usage_generator", "ibl_usage_rag", "ibl_idiom",
