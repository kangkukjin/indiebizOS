...
LAYERS = {
    ...
    "surface": {"member_shell", "member_workspace_ui", "member_browser", "member_app_frame", "member_entry", "member_apps", "public_face", "face_provision", "warehouse_likes", "launcher_react"},
}
