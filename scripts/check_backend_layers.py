...
LAYERS = {
    "base": {
        "history_excerpt", "distill_receipts", "trajectory_payload",
    ...
    "ibl": {
        ...
        "ibl_v2_compile", "ibl_v2_contracts", "ibl_v2_learning", "ibl_v2_compat", "ibl_v2_runtime", "ibl_v2_adapters", "ibl_v2_entry", "ibl_v2_store", "ibl_document_value", "ibl_member_library", "ibl_run_journal", "ibl_remote_call", "ibl_scheduled", "ibl_callable_contract",
        ...
        "ibl_safety", "ibl_translate", "package_manager", "vocabulary_lifecycle", "vocabulary_desktop", "vocabulary_archive", "vocabulary_import", "tool_context",
    ...
    "cognition": {
        ...
        "vocab_overlap_audit", "component_lifecycle", "guide_downscale",
    ...
    "services": {
        ...
        "phone_notifications", "sync_exchange", "chat_streams", "chat_runs",
